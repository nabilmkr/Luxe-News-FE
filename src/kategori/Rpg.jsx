...
import CarouselRPG from "../components/design/Carouselrpg";
...
const RPG = () => {
  ...
  useEffect(() => {
    const fetchNews = async () => {
      try {
        setLoading(true);
        const response = await getCategoryNews('RPG', searchTerm);
  ...
  return (
    <Section id="RPG">
      <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[3.875rem] md:mb-20 lg:mb-[6.25rem]">
        <h1 className="h1 mb-6">RPG Games</h1>
        <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">
          Masuki dunia pertempuran strategi real-time! Di kategori RPG, kami hadirkan update terbaru dari game-game populer seperti Mobile Legends, Dota 2, dan League of Legends.
        </p>
      </div>
